...
UPDATE TBWMWVALORPARAMETRO SET VLPAPARAMETRO ='ser="http://services.senior.com.br"' WHERE CDPARAMETRO='521';
UPDATE TBWMWVALORPARAMETRO SET VLPAPARAMETRO ='ser:GravarPedidos_15' WHERE CDPARAMETRO='522';
UPDATE TBWMWVALORPARAMETRO SET VLPAPARAMETRO ='parameters' WHERE CDPARAMETRO='523';
UPDATE TBWMWVALORPARAMETRO SET VLPAPARAMETRO='{"Content-Type":"N","envioPedidoIndividual":"S","usaReenvioPedidoIntegracaoWebServiceSOAP":"N"}' WHERE CDPARAMETRO='525';
