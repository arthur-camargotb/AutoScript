...
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='N' WHERE cdparametro IN('1146','1611','1612','1613','1614'); -- Validação de senhas, tempo de vencimento, regras etc
...
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO = 'S' WHERE CDPARAMETRO = '315'; -- Sugere envio pedido app
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO = 'S' WHERE CDPARAMETRO = '863'; -- Escolha empresa pedido
...
/* Parametros Sync*/
UPDATE tbwmwvalorparametro SET VLPARAMETRO='S' WHERE CDPARAMETRO='271';
UPDATE tbwmwvalorparametro SET VLPARAMETRO='720' WHERE CDPARAMETRO='269';
UPDATE tbwmwvalorparametro SET VLPARAMETRO='15000' WHERE CDPARAMETRO='270';

/* Data de Entrega */
UPDATE tbwmwvalorparametro SET VLPARAMETRO='1' WHERE CDPARAMETRO='467';
UPDATE tbwmwvalorparametro SET VLPARAMETRO='1' WHERE CDPARAMETRO='10';

/* Parametros Giro de Produtos */
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usa": "S","insereAutoSugestaoNovoPedidoGiroProduto": "N"}' WHERE CDPARAMETRO='698';
...
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usaMarcadorCliente":"1,2,4","usaMarcadorProduto":"N", "usaOrientacaoVerticalMarcadores":"N"}' WHERE CDPARAMETRO='1552';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='8;1;3' WHERE CDPARAMETRO='1782';

/* Pesquisa de Mercado */
UPDATE TBLVWCONFIGINTEGWEBTC SET FLATIVO='S' WHERE DSTABELA IN('TBLVPRELNOVPESQUISAMERC','TBLVPPESQUISAMERCADOCONFIG','TBLVPFOTOPESQMERPRODCONC','TBLVPPESQUISAMERCADOPRODUTO','TBLVPPESQUISAMERCADOREG','TBLVPPESQUISAMERCCONC');
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usa":"S","ignoraCliente":"N","permiteInserirNovoExcluirItem":"N","usaPesquisaPedido":"N","usaPesquisaItemPedido":"N","usaInclusaoFotoPesquisa":"N","usaInclusaoFotoProdPesquisa":"S","obrigaInclusaoFoto":"N","usaCadastroCoordenada":"N","permiteCoordenadaAuto":"N","timeOutCoordenadaAuto":"N","excluiPesquisaPedido":"N","geraNovidadePesquisa":"S"}'
WHERE CDPARAMETRO='1837';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usa": "S","permiteInserirSemVlProduto": "N","permiteInserirSemQtdGondola": "N"}' WHERE CDPARAMETRO='1128';
...
/* Modulo Produtos Similares e Complementares (Pegar a criação da tela de clientes postgres como planeta energia) */
UPDATE TBLVWCONFIGINTEGWEBTC SET FLATIVO='S' WHERE DSTABELA ='TBLVPPRODUTOSIMILAR';
UPDATE TBLVWCONFIGINTEGWEBTC SET FLATIVO='S' WHERE DSTABELA ='TBLVPPRODUTOCOMPLEMENTO';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usa":"S", "usaAgrupadorProduto":"N"}' WHERE CDPARAMETRO='693';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='1,2' WHERE CDPARAMETRO='1132';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='1;2' WHERE CDPARAMETRO='1710';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='15' WHERE CDPARAMETRO='1133';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='30' WHERE CDPARAMETRO='1134';

/* Requisicao De Servico */
UPDATE TBLVWCONFIGINTEGWEBTC SET FLATIVO='S' WHERE DSTABELA IN ('TBLVPREQUISICAOSERV','TBLVPREQUISICAOSERVIMAGEM','TBLVPREQUISICAOSERVMOTIVO','TBLVPREQUISICAOSERVRESP','TBLVPREQUISICAOSERVTIPMOT','TBLVPREQUISICAOSERVTIPO');

/* Pedido Pendente */
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='C' WHERE CDPARAMETRO='533';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='P' WHERE CDPARAMETRO='712';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usa":"2","usaCancPedAbertoAuto":"N","usaCancPedFechadoAuto":"N","nuDiaSemCanPedAbertoFechadoAuto":"N"}' WHERE CDPARAMETRO='675';
INSERT INTO TBLVWSTATUSPEDIDO (CDSTATUSPEDIDO,DSSTATUSPEDIDO,FLCREDITOCLIENTEABERTO,FLGERAACOMPOPORTUNIDADE,FLIGNORAHISTORICOITEM,FLATIVO)
VALUES ('C','Cancelado (WMW)','N','N','S','S');
INSERT INTO TBLVWSTATUSPEDIDO (CDSTATUSPEDIDO,DSSTATUSPEDIDO,FLCREDITOCLIENTEABERTO,FLGERAACOMPOPORTUNIDADE,FLIGNORAHISTORICOITEM,FLATIVO)
VALUES ('P','Pendente (WMW)','S','S','N','S');
INSERT INTO TBLVWSTATUSPEDIDOPDA (CDSTATUSPEDIDO,DSSTATUSPEDIDO,FLCREDITOCLIENTEABERTO,FLCOMPLEMENTAVEL,FLIGNORAHISTORICOITEM,FLATIVO)
VALUES ('C','Cancelado (WMW)','N','N','S','S');
INSERT INTO TBLVWSTATUSPEDIDOPDA (CDSTATUSPEDIDO,DSSTATUSPEDIDO,FLCREDITOCLIENTEABERTO,FLCOMPLEMENTAVEL,FLIGNORAHISTORICOITEM,FLATIVO)
VALUES ('P','Pendente (WMW)','S','S','N','S');

/* Frete */
UPDATE TBLVWCONFIGINTEGWEBTC SET FLATIVO='S' WHERE DSTABELA ='TBLVPTIPOFRETE';
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"usa":"S","configFreteEmbutidoDestacadoCliente":"N","validaConversaoFOB":"N","cdStatusPedidoFOBPendenteAprovacao":"0"}' WHERE CDPARAMETRO='4';

/* Recado */
--Se usuario normal poder enviar habilitar no prm 117
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='887'; --Habilita campo para definir se resposta é obrigatoria
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='225'; -- Obriga leitura recado

/* Aniversariantes */
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='285'; -- Mostra aniversariantes primeiro login

/* Novidades */
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='178'; -- Mostra novidade produtos
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='864'; -- Mostra novidade novos produtos
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='{"geraNovidadeMenorPreco":"S","geraNovidadeMaiorPreco":"S","geraNovidadeInterpolacao":"N"}' WHERE CDPARAMETRO='759'; -- Novidades mudança de preço
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='1371'; -- Mostra novidade novos clientes
UPDATE TBWMWVALORPARAMETRO SET VLPARAMETRO='S' WHERE CDPARAMETRO='1372'; -- Mostra novidade novos clientes junto de produtos
